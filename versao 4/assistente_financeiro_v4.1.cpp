...
{
	printf("DIAGNOSTICO E DICAS FINANCEIRAS.\n");
...
void criarReserva(float gastosFixos)
{
...
void criarMeta(int meses, float meta, float economiaMensal, float metaRestante)
{
	printf("\nMETA FINANCEIRA.\n");
...
void simularQuitarDivida(int meses, float salario, float divida1, float dividas, float pagMensal, float percentualQuitacao)
{
			meses = 0;
			divida1 = dividas;
...
int main()
{
    ...
    switch(opcao)
    {
        ...
        case 2:
        	...
        	{
			simularQuitarDivida(meses, divida1, salario, dividas, pagMensal, percentualQuitacao);
			}
            break;
        ...
        case 4:
            ...
            {
            	criarReserva(gastosFixos);
        	}
			break;
		
		case 5:
			criarMeta(meses, meta, economiaMensal, metaRestante);
			break;
